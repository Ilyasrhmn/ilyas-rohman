...
export function ProjectCard({ project, index }: { project: Project; index: number }) {
  return (
    <Link
      ...
      className="group relative block aspect-[4/3] w-full overflow-hidden rounded-2xl border border-[var(--world-a-border)] bg-[var(--world-a-surface)] transition-colors hover:border-[var(--world-a-accent)]"
    >
