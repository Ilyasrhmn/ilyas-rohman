          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            <div className="relative">
              <div ref={githubRef} className="absolute -top-4 right-0 md:right-2 text-primary/60 hover:text-primary z-20 opacity-0">
                <a
                  href={personal.socialLinks.find((s: any) => s.platform === 'GitHub')?.url}
                  target="_blank"
                  className="block"
                >
                  <Github size={32} />
          ...
          <div className="md:flex gap-8 items-center relative">
            <div className="relative">
              <div ref={linkedinRef} className="absolute -top-8 left-4 text-primary/60 hover:text-primary z-20 opacity-0">
                <a
                  href={personal.socialLinks.find((s: any) => s.platform === 'LinkedIn')?.url}
                  target="_blank"
                  className="block"
                >
                  <Linkedin size={32} />
              ...
              <div ref={instagramRef} className="absolute -bottom-12 right-24 md:right-36 text-primary/60 hover:text-primary z-20 opacity-0">
                <a
                  href={personal.socialLinks.find((s: any) => s.platform === 'Instagram')?.url}
                  target="_blank"
                  className="block"
                >
                  <Instagram size={32} />
            ...
            {showProfile && (
              ...
              >
                <ProfileCard
                  ...
                  githubUrl={personal.socialLinks.find((s: any) => s.platform === 'GitHub')?.url}
                  linkedinUrl={personal.socialLinks.find((s: any) => s.platform === 'LinkedIn')?.url}
                  instagramUrl={personal.socialLinks.find((s: any) => s.platform === 'Instagram')?.url}
